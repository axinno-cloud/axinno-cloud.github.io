    ...
    return <Layout>
        ...
        <h1 className="mb-5 text-5xl font-bold">Hello there</h1>
            ...
            <div className="flex justify-center w-full mb-5">
                <CompatBtn autoFocus={true} className="bg-emerald-400 hover:bg-emerald-500 text-white font-bold py-2 px-4 rounded-full" href="/install">Install</CompatBtn>
                <div className="divider divider-horizontal" />
                <CompatBtn className="bg-emerald-400 hover:bg-emerald-500 text-white font-bold py-2 px-4 rounded-full" href="/repos">Repositories</CompatBtn>
            </div>
